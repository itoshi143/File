...
import os,base64
os.system("xdg-open https://t.me/SURCHY_CRACKER")
import time, json, string
os.system('touch /sdcard/@ITOSHI_TERU')
...
try:
	open('/sdcard/@ITOSHI_TERU.txt','w').write(' ')
...
class file_create_menu():
	...
	def file_simple(self):
		os.system('clear');print(logo)
		save_as = input(" TYPE [/sdcard/@@KG_BLACK.txt : ")
